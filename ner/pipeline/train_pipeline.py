...
from ner.entity.artifacts_entity import DataIngestionArtifacts, DataTransformationArtifacts, ModelTrainingArtifacts, ModelEvaluationArtifacts
...
class TrainPipeline:
    ...
    def start_model_evaluation(self, data_transformation_artifact: DataTransformationArtifacts, model_trainer_artifact: ModelTrainingArtifacts) -> ModelEvaluationArtifacts:
        try:
            ...
            model_evaluation = ModelEvaluation(data_transformation_artifacts=data_transformation_artifact, model_training_artifacts=model_trainer_artifact, 
